...
`;
export const listChemicalAnalyses = /* GraphQL */ `
  query ListChemicalAnalyses(
...
`;
export const listTestPackChemicalAnalyses = /* GraphQL */ `
  query ListTestPackChemicalAnalyses(
...
`;
export const listImpactCategories = /* GraphQL */ `
  query ListImpactCategories(
