...
interface IState {
  ...
  class TestPack extends Component<any,IState> {
      ...
      componentDidMount(){
        this.props.getDataList(listTestPacks);
      }
      render() {
        return (
          <div>
            {this.props.isLoadingFailed && <CButton onClick={()=>{this.props.getDataList(listTestPacks)}}>Refresh</CButton>}
                ...
                <CTableBody>
                  {
                    ...
                    this.props.data.map((item: any, index:any) => (
                      <CTableRow key={index}>
                        ...
                        <CTableDataCell>
                        <div>
                          <CButton className='primary' color="link" onClick={()=>{this.setState({showDetail: true}); this.props.getItemDetail(getTestPack,item.id);}} disabled={this.props.isLoaingItemDetail}>Detail</CButton>
            ...
            >
              ...
              <CModalFooter>
                ...
                <CButton onClick={()=>{
                  this.props.deleteItem(deleteTestPack,this.state.toBeDeletedId,listTestPacks); this.setState({showDeleteAlert: false})} } color="primary">Ok</CButton>
              </CModalFooter>
            </CModal>
            ...
            >
              ...
              <CModalBody>
                <CreateTestPackComponent onclick={()=> this.setState({showCreate: false})}/>
              </CModalBody>
            </CModal>
            ...
            >
              ...
              <CModalBody>
                <UpdateTestPackComponent onclick={()=> this.setState({showEdit: false})} toBeUpdatedItem={this.state.toBeUpdatedId}/>
              </CModalBody>
            </CModal>
            ...
            >
              ...
              <CModalBody>
                <GetTestPackComponent onclick={()=> this.setState({showDetail: false})} fetchedItem={this.props.fetchedItem}/>
              </CModalBody>
            </CModal>
...
export default connect(mapStateToProps, mapDispatchToProps)(TestPack)
...
const mapDispatchToProps2  = {
  ...
  const CreateTestPackComponent: React.FC<any> = connect(mapStateToProps2,mapDispatchToProps2)((props: any) => {
    ...
    const onSubmit = (data: IState2) => {
      ...
      props.createItem(createTestPack,inputData);
      props.onclick();
    };
...
const mapDispatchToProps3  = {
  ...
  const UpdateTestPackComponent: React.FC<any> = connect(mapStateToProps3,mapDispatchToProps3)((props: any) => {
    //console.log('rendered with props:',props);
    ...
    const onSubmit = (data: IState3) => {
      ...
      props.updateItem(updateTestPack,inputData);
      props.onclick();
    };
...
const GetTestPackComponent: React.FC<any> = connect(mapStateToProps4,mapDispatchToProps4)((props: any) => {
  //console.log('rendered with props:',props);
