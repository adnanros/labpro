...
import { getImpactCategory,  listImpactCategorys,   } from '../../../graphql/queries';
import React from 'react';
import { createImpactCategory,  deleteImpactCategory,  updateImpactCategory,  } from '../../../graphql/mutations';
...
class ImpactCategory extends Component<any,IState> {
    ...
    componentDidMount(){
      this.props.getDataList(listImpactCategorys);
    }
    render() {
      return (
        <div>
          {this.props.isLoadingFailed && <CButton onClick={()=>{this.props.getDataList(listImpactCategorys)}}>Refresh</CButton>}
                ...
                <CTableBody>
                  {
                    ...
                    this.props.data.map((item: any, index:any) => (
                      <CTableRow key={index}>
                        ...
                        <CTableDataCell>
                        <div>
                          <CButton className='primary' color="link" onClick={()=>{this.setState({showDetail: true}); this.props.getItemDetail(getImpactCategory,item.id);}} disabled={this.props.isLoaingItemDetail}>Detail</CButton>
            ...
            >
              ...
              <CModalFooter>
                ...
                <CButton onClick={()=>{
                  this.props.deleteItem(deleteImpactCategory,this.state.toBeDeletedId,listImpactCategorys); this.setState({showDeleteAlert: false})} } color="primary">Ok</CButton>
              </CModalFooter>
            </CModal>
            ...
            >
              <CModalHeader>
                <CModalTitle>Create Impact Category</CModalTitle>
              </CModalHeader>
              <CModalBody>
                <CreateImpactCategoryComponent onclick={()=> this.setState({showCreate: false})}/>
              </CModalBody>
            </CModal>
            ...
            >
              <CModalHeader>
                <CModalTitle>Edit Impact Category</CModalTitle>
              </CModalHeader>
              <CModalBody>
                <UpdateImpactCategoryComponent onclick={()=> this.setState({showEdit: false})} toBeUpdatedItem={this.state.toBeUpdatedId}/>
              </CModalBody>
            </CModal>
            ...
            >
              <CModalHeader>
                <CModalTitle>Impact Category Item Details</CModalTitle>
              </CModalHeader>
              <CModalBody>
                <GetImpactCategoryComponent onclick={()=> this.setState({showDetail: false})} fetchedItem={this.props.fetchedItem}/>
              </CModalBody>
            </CModal>
...
export default connect(mapStateToProps, mapDispatchToProps)(ImpactCategory)
...
const mapDispatchToProps2  = {
  ...
  const CreateImpactCategoryComponent: React.FC<any> = connect(mapStateToProps2,mapDispatchToProps2)((props: any) => {
    ...
    const onSubmit = (data: IState2) => {
      ...
      props.createItem(createImpactCategory,inputData);
      props.onclick();
    };
...
const mapDispatchToProps3  = {
  ...
  const UpdateImpactCategoryComponent: React.FC<any> = connect(mapStateToProps3,mapDispatchToProps3)((props: any) => {
    //console.log('rendered with props:',props);
    ...
    const onSubmit = (data: IState3) => {
      ...
      props.updateItem(updateImpactCategory,inputData);
      props.onclick();
    };
...
const GetImpactCategoryComponent: React.FC<any> = connect(mapStateToProps4,mapDispatchToProps4)((props: any) => {
  //console.log('rendered with props:',props);
